...
file = open(r'C:\Users\Naveen\OneDrive\Desktop\b.tech project\word search\word-search-main\report.txt', encoding="utf8")
text = ""
while True:
	line = file.readline()
	text += line
...
def indexPage():
	return open(r"C:\Users\Naveen\OneDrive\Desktop\b.tech project\word search\word-search-main\index.html").read()
...
# Main Function, Runs at http://0.0.0.0:3000
